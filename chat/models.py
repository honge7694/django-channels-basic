...
class OnlineUserMixin(models.Model):
    ...
    def user_join(self, channel_name, user):
        ...
        is_new_join = len(room_member.channel_names) == 0 # 처음으로 채팅방에 들어온 상황.
        room_member.channel_names.add(channel_name) # 메모리에만 저장 DB저장X
    ...
    def user_leave(self, channel_name, user):
        ...
        room_member.channel_names.remove(channel_name) # 메모리에만 저장.
        # DB 저장.
